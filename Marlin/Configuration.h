 ...
 *    (0,0)
 */
#define X_PROBE_OFFSET_FROM_EXTRUDER -20 //31  // X offset: -left  +right  [of the nozzle]
#define Y_PROBE_OFFSET_FROM_EXTRUDER -7.5 //-33 // Y offset: -front +behind [the nozzle]
 ...
 */
#define Z_CLEARANCE_DEPLOY_PROBE   5 // Z Clearance for Deploy/Stow (default 15)
...
#define HOMING_FEEDRATE_Z  (20*60) //Default 16*60
